...
constexpr long long MAX_INT = 0x7FFFFFFF;
constexpr long long MIN_INT = 0x80000000;

constexpr long long LSB_MASK = 0x7FFFFFFE;
...
public:
	...
	{
		int oldvalue = reinterpret_cast<int>(node);

		int newvalue = reinterpret_cast<int>(node);
